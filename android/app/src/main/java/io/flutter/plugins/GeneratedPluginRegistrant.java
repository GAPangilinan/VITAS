...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.markosyan.flutter_zxing.FlutterZxingPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin flutter_zxing, com.markosyan.flutter_zxing.FlutterZxingPlugin", e);
    }
    try {
